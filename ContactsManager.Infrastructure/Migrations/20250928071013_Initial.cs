        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxIdentificationNumber = table.Column<string>(type: "nvarchar(12)", nullable: true, defaultValue: "12keshav1234")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Persons", x => x.PersonID);
                    table.CheckConstraint("CHK_TIN", "len([TaxIdentificationNumber])=12");
                    table.ForeignKey(
