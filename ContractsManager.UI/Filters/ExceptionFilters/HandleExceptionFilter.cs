...
namespace CURDDEMO.Filters.ExceptionFilters
{
    public class HandleExceptionFilter : IExceptionFilter
    {
        ...
        {
            _logger.LogError("Exception Filter {filterName}.{MethodName} \n{ExceptionType}\n {ExpectionMessage}", nameof(HandleExceptionFilter), nameof(OnException), context.Exception.GetType().ToString(), context.Exception.Message);
